...
public class ViewPage extends Composite {
	...
	public ViewPage(BinService service, Composite parent, int style) {
		...
		tblclmnNewColumn_0.setWidth(30);
		...
		TableColumn tableColumn_66 = tableViewerColumn_66.getColumn();
		tableColumn_66.setWidth(30);
		tableColumn_66.setText("6");
		tableViewerColumn_66.setEditingSupport(byteCellEditorSupport);
		...
		tblclmnNewColumn_4.setText("ASCII");
